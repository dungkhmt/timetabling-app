...
package openerp.openerpresourceserver.wms.timeseries.arima.struct;

import openerp.openerpresourceserver.wms.timeseries.arima.ArimaSolver;
...
public class ForecastResult {
    ...
    private ArimaParams modelParams;

    /**
     * Setter for model parameters
     *
     * @param params the ARIMA parameters used for forecasting
     */
    public void setModelParams(ArimaParams params) {
     ...
     *
     * @return the ARIMA parameters used for forecasting
     */
    public ArimaParams getModelParams() {
